...
#SBATCH --requeue
#SBATCH --job-name=till_allpth_split
...
#SBATCH --output=/home/a.norouzikandelati/Projects/tillage_mapping/code/kamiak_job_files/out_err_till/output_split_num_%A_%a.out
#SBATCH --error=/home/a.norouzikandelati/Projects/tillage_mapping/code/kamiak_job_files/out_err_till/error_split_num_%A_%a.err
...
srun --export=ALL,PYTHONPATH= "$PY" /home/a.norouzikandelati/Projects/tillage_mapping/code/train_till_models.py "$SPLIT_NUM"
