...
#SBATCH --output=/home/a.norouzikandelati/Projects/tillage_mapping/code/kamiak_job_files/out_err_fr_models/output_split_num_%A_%a.out
#SBATCH --error=/home/a.norouzikandelati/Projects/tillage_mapping/code/kamiak_job_files/out_err_fr_models/error_split_num_%A_%a.err
...
srun --export=ALL,PYTHONPATH= "$PY" /home/a.norouzikandelati/Projects/tillage_mapping/code/train_fr_models.py "$SPLIT_NUM"
