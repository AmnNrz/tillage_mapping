...
#SBATCH --output=/home/a.norouzikandelati/Projects/tillage_mapping/code/kamiak_job_files/out_err_fullmap/output_batch_number_%A_%a.out
#SBATCH --error=/home/a.norouzikandelati/Projects/tillage_mapping/code/kamiak_job_files/out_err_fullmap/error_batch_number_%A_%a.err
...
# Run your job with the same clean environment
srun --export=ALL,PYTHONPATH= "$PY" \
    /home/a.norouzikandelati/Projects/tillage_mapping/code/download_imagery.py \
    600 "$batch_number"
