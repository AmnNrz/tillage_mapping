...
#SBATCH --output=/home/a.norouzikandelati/Projects/tillage_mapping/code/kamiak_job_files/out_err_till_p0p100/output_split_num_%A_%a.out
#SBATCH --error=/home/a.norouzikandelati/Projects/tillage_mapping/code/kamiak_job_files/out_err_till_p0p100/error_split_num_%A_%a.err
...
srun --export=ALL,PYTHONPATH= "$PY" /home/a.norouzikandelati/Projects/tillage_mapping/code/train_till_models_p0p100.py "$SPLIT_NUM"
